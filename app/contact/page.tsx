...
export default function ContactPage(): JSX.Element {
  ...
  return (
    <div className="flex flex-col">
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div className="space-y-1">
                    <p className="text-lg font-medium">Visit Our Store</p>
                    <p className="text-gray-500">123 Keyboard Street</p>
                    <p className="text-gray-500">Tech City, TC 98765</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-gray-500">support@keyboardhaven.com</p>
                    <p className="text-gray-500">sales@keyboardhaven.com</p>
                  </div>
                </div>
              </div>
      ...
      {/* Map Section */}
      <section className="container mx-auto px-4 md:px-6 h-96 bg-gray-200">
